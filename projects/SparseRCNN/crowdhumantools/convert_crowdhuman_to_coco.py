...
DATA_PATH = '/media/lab308/c06b8ee9-baa0-4d90-845c-51b2bdc44856/data/crowdhuman/'
OUT_PATH = '/home/lab308/annotations/'
SPLITS = ['val', 'train']
DEBUG = False
...
if __name__ == '__main__':
    ...
    for split in SPLITS:
        ...
        # num_person = 0
        # for anno in anns_data:
        #     num_gt = len(anno['gtboxes'])
        #     num_person = max(num_person, num_gt)
        #     if num_person == num_gt:
        #         id = anno['ID']
        # print(id, num_person)
        image_cnt = 0
        ann_cnt = 0
